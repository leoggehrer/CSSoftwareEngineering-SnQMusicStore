...
namespace CSharpCodeGenerator.Logic
{
    public partial class Factory
    {
        ...
        public static Contracts.IModelGenerator GetTelerikBlazorServerAppGenerator(string solutionName, string contractsFilePath)
        {
            return TelerikBlazorServerAppGenerator.Create(SolutionProperties.Create(solutionName, contractsFilePath));
        }
