...
{
    using System;
    partial class LoginSession : SnQMusicStore.Contracts.Persistence.Account.ILoginSession
    {
        static LoginSession()
        {
            ClassConstructing();
        ...
        public void CopyProperties(SnQMusicStore.Contracts.Persistence.Account.ILoginSession other)
        {
            if (other == null)
            {
        ...
        partial void BeforeCopyProperties(SnQMusicStore.Contracts.Persistence.Account.ILoginSession other, ref bool handled);
        partial void AfterCopyProperties(SnQMusicStore.Contracts.Persistence.Account.ILoginSession other);
        public override bool Equals(object obj)
        {
            if (obj is not SnQMusicStore.Contracts.Persistence.Account.ILoginSession instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMusicStore.Contracts.Persistence.Account.ILoginSession other)
        {
            if (other == null)
            {
                return false;
        ...
        public static Persistence.Account.LoginSession Create(SnQMusicStore.Contracts.Persistence.Account.ILoginSession other)
        {
            BeforeCreate(other);
            var result = new Persistence.Account.LoginSession();
        ...
        static partial void BeforeCreate(SnQMusicStore.Contracts.Persistence.Account.ILoginSession other);
        static partial void AfterCreate(Persistence.Account.LoginSession instance, SnQMusicStore.Contracts.Persistence.Account.ILoginSession other);
    }
}
