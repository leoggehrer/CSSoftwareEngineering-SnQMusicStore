...
{
    using System;
    partial class Track : SnQMusicStore.Contracts.Persistence.MusicStore.ITrack
    {
        static Track()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQMusicStore.Contracts.Persistence.MusicStore.ITrack instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMusicStore.Contracts.Persistence.MusicStore.ITrack other)
        {
            if (other == null)
            {
                return false;
            ...
            && IsEqualsWith(Composer, other.Composer)
            && Milliseconds == other.Milliseconds
            && Bytes == other.Bytes
            && UnitPrice == other.UnitPrice;
        }
        ...
        {
            return HashCode.Combine(AlbumId, GenreId, Title, Composer, Milliseconds, Bytes, HashCode.Combine(UnitPrice));
        }
