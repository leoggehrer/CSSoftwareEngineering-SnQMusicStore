...
{
    using System;
    partial class Artist : SnQMusicStore.Contracts.Persistence.MusicStore.IArtist
    {
        static Artist()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQMusicStore.Contracts.Persistence.MusicStore.IArtist instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMusicStore.Contracts.Persistence.MusicStore.IArtist other)
        {
            if (other == null)
            {
                return false;
