...
{
    using System;
    partial class Album : SnQMusicStore.Contracts.Persistence.MusicStore.IAlbum
    {
        static Album()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQMusicStore.Contracts.Persistence.MusicStore.IAlbum instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMusicStore.Contracts.Persistence.MusicStore.IAlbum other)
        {
            if (other == null)
            {
                return false;
        ...
        {
            return HashCode.Combine(ArtistId, Title);
        }
